...
const getLecture = id => lectures.find(lecture => lecture.id === id);
    ...
    timeSlots: [
      {
        ...
        heading: CATEGORIES.KEYNOTE,
        lectures: [getLecture(IDS.KEYNOTE_SOFTWARE_ACRHITECTURE)],
      },
      {
        time: TIME_SLOTS['10:15'],
        heading: CATEGORIES.LANGUAGES,
        lectures: [
      ...
      },
      {
        ...
        lectures: [{ title: 'Developer Survey QA', id: 'survey' }],
      },
      {
      ...
      },
      {
        ...
        lectures: [getLecture(IDS.OMNIA)],
      },
      {
        time: TIME_SLOTS['15:00'],
        heading: CATEGORIES.MINIWORKSHOPS,
        lectures: [
      ...
      },
      {
        ...
        leisure: 'Leisure and activities',
      },
      {
    ...
    timeSlots: [
      {
        time: TIME_SLOTS['09:00'],
        heading: CATEGORIES.KEYNOTE,
        lectures: [getLecture(IDS.KEYNOTE_FEEDBACK_DRIVEN_DEVELOPMENT)],
      },
      {
        time: TIME_SLOTS['10:15'],
        heading: CATEGORIES.WORKSHOPS,
        lectures: [
